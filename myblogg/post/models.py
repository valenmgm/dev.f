...
class Categoria(models.Model):
    #Attributes
    nombre_cat = models.CharField(max_length=150, blank=False)

    def __str__(self):
        return unicode(self.nombre_cat)
...
class Post(models.Model):
    ...
    categoria = models.ForeignKey(Categoria, related_name='es_de_categoria')

    def make(self, titulo, contenido, imagen, autor, categoria):
        self.titulo = titulo
